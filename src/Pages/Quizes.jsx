    ...
    return (<Main>
            ...
            <MainContainer>
                <ScrollableComponent>
                    ...
                    {quizList?.map((quiz) => (<ListItem
                        style={style}
                        name={quiz.topic}
                        right={quiz.questions?.length}
                        path={`/quizes/take-quiz/${quiz._id}`}
                        image={"https://firebasestorage.googleapis.com/v0/b/space-odyssey-28b84.appspot.com/o/background%2Fquiz1.jpg?alt=media&token=cd0075ab-394a-4631-bf93-f83e38f01e49"}
                    />))}
                </ScrollableComponent>
            </MainContainer>
